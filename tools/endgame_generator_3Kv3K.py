...
def get_king_moves(position):
    """
    Generates all legal moves for the current player from a given 3K v 3K position.
    Position: (rk1, rk2, rk3, wk1, wk2, wk3, turn)
    """
        ...
        for dr, dc in [(-1, -1), (-1, 1), (1, -1), (1, 1)]:
            ...
            if land_coord in COORD_TO_ACF and land_coord not in board:
                ...
                if jumped_piece_sq in opponent_pieces:
                    # Any jump simplifies to a 3v2 endgame, a known win for the side with 3.
...
def generate_3Kv3K_positions():
    """Generates all positions for 3 Red Kings vs 3 White Kings."""
    positions = set()
...
if __name__ == '__main__':
    ...
    print("\nStarting retrograde analysis for 3 Kings vs 3 Kings...")
